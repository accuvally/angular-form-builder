...
a.get("$drag");b.formName=l.fbBuilder;null==(m=f.forms)[h=b.formName]&&(m[h]=[]);b.formObjects=f.forms[b.formName];k=!0;$(d).addClass("fb-builder");return c.droppable($(d),{move:function(a){var l,f,c,m,h,e;k&&($("div.fb-form-object-editable").popover("hide"),k=!1);f=$(d).find(".fb-form-object-editable:not(.empty,.dragging)");if(0===f.length)0===$(d).find(".fb-form-object-editable.empty").length&&$(d).find(">div:first").append($("<div class='fb-form-object-editable empty'></div>"));else{m=[];m.push(-1E3);
c=h=0;for(e=f.length;h<e;c=h+=1)l=$(f[c]),c=l.offset(),l=l.height(),m.push(c.top+l/2);m.push(m[m.length-1]+1E3);h=-1;for(c=e=b.formObjects.length-1;0<=e;c=e+=-1)if(!b.formObjects[c].editable){h=c;break}c=h=0<=h?h+2:1;for(e=m.length;h<e;c=h+=1)if(a.pageY>m[c-1]&&a.pageY<=m[c]){$(d).find(".empty").remove();a=$("<div class='fb-form-object-editable empty'></div>");c-1<f.length?a.insertBefore($(f[c-1])):a.insertAfter($(f[c-2]));break}}},out:function(){k&&($("div.fb-form-object-editable").popover("hide"),
k=!1);return $(d).find(".empty").remove()},up:function(a,m,h){k=!0;if(c.isMouseMoved())return m||"drag"!==h.mode?m&&("mirror"===h.mode&&(a=$(d).find(".empty").index(".fb-form-object-editable"),0<=a&&f.insertFormObject(b.formName,$(d).find(".empty").index(".fb-form-object-editable"),{component:h.object.componentName})),"drag"===h.mode&&(a=h.object.formObject.index,h=$(d).find(".empty").index(".fb-form-object-editable"),a<h&&h--,f.updateFormObjectIndex(b.formName,a,h))):(h=h.object.formObject,h.editable&&
f.removeFormObject(l.fbBuilder,h.index)),$(d).find(".empty").remove();$(d).find(".empty").remove()}})}}};e.$inject=["$injector"];g.directive("fbBuilder",e);e=function(a){return{restrict:"A",controller:"fbFormObjectEditableController",link:function(b,d,l){var c,e,k,m,h,n,q,g;m=a.get("$builder");n=a.get("$drag");k=a.get("$parse");h=a.get("$compile");q=a.get("$validator");k=k(l.fbFormObjectEditable)(b);l=m.components[k.component];b.setupScope(k);g=h(l.template)(b);$(d).append(g);$(d).on("click",function(){return!1});
if(k.editable)return n.draggable($(d),{object:{formObject:k}}),c="fb-"+Math.random().toString().substr(2),e=!1,k=null,k=l.popoverTemplate,k=$(k).addClass(c),b.popover={save:function(a){a.preventDefault();q.validate(b).success(function(){e=!0;return $(d).popover("hide")})},remove:function(a){a.preventDefault();m.removeFormObject(b.formName,b.$index);$(d).popover("hide")},shown:function(){b.data.backup();return e=!1},cancel:function(a){b.data.rollback();a&&(a.preventDefault(),$(d).popover("hide"))}},
k=h(k)(b),$(d).addClass(c),$(d).popover({html:!0,title:l.label,content:k,container:"body"}),$(d).on("show.bs.popover",function(){var a,b;if(n.isMouseMoved())return!1;$("div.fb-form-object-editable:not(."+c+")").popover("hide");a=$("form."+c).closest(".popover");if(0<a.length)return b=$(d).offset().top+$(d).height()/2,b-=a.height()/2,a.css({position:"absolute",top:b}),a.show(),setTimeout(function(){a.addClass("in");return $(d).triggerHandler("shown.bs.popover")},0),!1}),$(d).on("shown.bs.popover",
function(){$(".popover ."+c+" input:first").select();b.$apply(function(){return b.popover.shown()})}),$(d).on("hide.bs.popover",function(){var a;a=$("form."+c).closest(".popover");e||(b.$$phase?b.popover.cancel():b.$apply(function(){return b.popover.cancel()}));a.removeClass("in");setTimeout(function(){return a.hide()},300);return!1})}}};e.$inject=["$injector"];g.directive("fbFormObjectEditable",e);g.directive("fbComponents",function(){return{restrict:"A",template:'<ul ng-if="groups.length > 1" class="nav nav-tabs nav-justified">\n    <li ng-repeat="group in groups" ng-class="{active:activeGroup==group}">\n        <a href=\'#\' ng-click="selectGroup($event, group)">{{group}}</a>\n    </li>\n</ul>\n<div class=\'form-horizontal\'>\n    <div class=\'fb-component\' ng-repeat="component in components"\n        fb-component="component"></div>\n</div>',
...
b.$on(f.broadcastChannel.updateInput,function(){var a;return b.updateInput([null!=(a=b.inputText)?a:""])});k.arrayToText&&(b.inputArray=[],b.$watch("inputArray",function(a,d){var c,l;if(a!==d){c=[];for(l in b.inputArray)b.inputArray[l]&&c.push(b.options[l]);return b.updateInput(c)}},!0));b.$watch("inputText",function(a){return b.updateInput([a])});b.$parent.$watch("input["+b.$index+"].value",function(a){var d,l,f,k,e;if(a){1===a.length&&a[0]&&(b.inputText=a[0]);l=b.options?b.options.length:0;e=[];
for(d=f=0;f<l;d=f+=1)e.push(b.inputArray[d]=(k=b.options[d],0<=c.call(a,k)));return e}},!0);b.$watch(l.fbFormObject,function(){return b.copyObjectToScope(b.formObject)},!0);l=$(k.template);l.find("[ng-model='inputText']").attr({validator:"{{validation}}","validator-error":"{{errorMessage}}"});e=e(l)(b);$(d).append(e);if(!k.arrayToText&&0<b.formObject.options.length)return b.inputText=b.formObject.options[0]}}};e.$inject=["$injector"];g.directive("fbFormObject",e)}).call(this);
...
"-"+this.s4()+"-"+this.s4()+this.s4()+this.s4()};this.getEmptyGuid=function(){return"00000000-0000-0000-0000-000000000000"};this.convertComponent=function(c,a){var b,d,e,f,g,k,m,h,n,q,s,r;b={name:c,group:null!=(d=a.group)?d:"Default",label:null!=(e=a.label)?e:"",description:null!=(g=a.description)?g:"",placeholder:null!=(k=a.placeholder)?k:"",editable:null!=(m=a.editable)?m:!0,required:null!=(h=a.required)?h:!1,validation:null!=(n=a.validation)?n:"/.*/",validationOptions:null!=(q=a.validationOptions)?
q:[],errorMessage:null!=(s=a.errorMessage)?s:"",options:null!=(r=a.options)?r:[],arrayToText:null!=(f=a.arrayToText)?f:!1,template:a.template,popoverTemplate:a.popoverTemplate};b.template||console.error("The template is empty.");b.popoverTemplate||console.error("The popoverTemplate is empty.");return b};this.convertFormObject=function(c,a){var b,d,e,f,g,k,m,h,n,q,s;null==a&&(a={});b=this.components[a.component];if(null==b)throw"The component "+a.component+" was not registered.";return{id:null!=(d=
a.id)?d:this.getNewGuid(),component:a.component,editable:null!=(e=a.editable)?e:b.editable,index:null!=(f=a.index)?f:0,label:null!=(g=a.label)?g:b.label,description:null!=(k=a.description)?k:b.description,placeholder:null!=(m=a.placeholder)?m:b.placeholder,options:null!=(h=a.options)?h:b.options,required:null!=(n=a.required)?n:b.required,validation:null!=(q=a.validation)?q:b.validation,errorMessage:null!=(s=a.errorMessage)?s:b.errorMessage}};this.reindexFormObject=function(c){var a,b,d;c=e.forms[c];
a=b=0;for(d=c.length;b<d;a=b+=1)c[a].index=a};this.registerComponent=function(c,a){var b,d;null==a&&(a={});null==e.components[c]?(b=e.convertComponent(c,a),e.components[c]=b,(d=b.group,0>g.call(e.groups,d))&&e.groups.push(b.group)):console.error("The component "+c+" was registered.")};this.addFormObject=function(c,a){var b;null==a&&(a={});null==(b=e.forms)[c]&&(b[c]=[]);return e.insertFormObject(c,e.forms[c].length,a)};this.insertFormObject=function(c,a,b){var d;null==b&&(b={});null==(d=e.forms)[c]&&
