...
for(a in c)d=c[a],b[a.replace(/^\w?/,a.substr(0,1).toLowerCase())]=d;return b}};this.convertComponent=function(c,a){var b,d,e,f,g,k,m,h,n,p,r;b={name:c,group:null!=(d=a.group)?d:"Default",label:null!=(e=a.label)?e:"",description:null!=(f=a.description)?f:"",placeholder:null!=(g=a.placeholder)?g:"",editable:null!=(k=a.editable)?k:!0,required:null!=(m=a.required)?m:!1,validation:null!=(h=a.validation)?h:"/.*/",validationOptions:null!=(n=a.validationOptions)?n:[],options:null!=(p=a.options)?p:[],arrayToText:null!=
(r=a.arrayToText)?r:!1,template:a.template,popoverTemplate:a.popoverTemplate};b.template||console.error("The template is empty.");b.popoverTemplate||console.error("The popoverTemplate is empty.");return b};this.convertFormObject=function(c,a){var b,d,e,f,g,k,m,h,n,p,r,q;null==a&&(a={});a=this.bleach.toLowerCase(a);a.id=null!=(b=a.id)?b:a.idNumber;a.index=null!=(d=a.index)?d:a.orderBy;b=this.components[a.component];if(null==b)throw"The component "+a.component+" was not registered.";return{id:null!=
(g=a.id)?g:null,component:a.component,Component:a.component,editable:null!=(k=a.editable)?k:b.editable,Editable:null!=(m=a.editable)?m:b.editable,index:null!=(h=a.index)?h:0,label:null!=(n=a.label)?n:b.label,description:null!=(p=a.description)?p:b.description,placeholder:null!=(r=a.placeholder)?r:b.placeholder,options:null!=(q=a.options)?q:b.options,required:null!=(e=a.required)?e:b.required,validation:null!=(f=a.validation)?f:b.validation}};this.reindexFormObject=function(c){var a,b,d;c=e.forms[c];
a=b=0;for(d=c.length;b<d;a=b+=1)c[a].index=a,c[a].OrderBy=a};this.registerComponent=function(c,a){var b,d;null==a&&(a={});null==e.components[c]?(b=e.convertComponent(c,a),e.components[c]=b,(d=b.group,0>g.call(e.groups,d))&&e.groups.push(b.group)):console.error("The component "+c+" was registered.")};this.addFormObject=function(c,a){var b;null==a&&(a={});null==(b=e.forms)[c]&&(b[c]=[]);return e.insertFormObject(c,e.forms[c].length,a)};this.insertFormObject=function(c,a,b){var d;null==b&&(b={});null==
(d=e.forms)[c]&&(d[c]=[]);a>e.forms[c].length?a=e.forms[c].length:0>a&&(a=0);e.forms[c].splice(a,0,e.convertFormObject(c,b));return e.reindexFormObject(c)};this.removeFormObject=function(c,a){e.forms[c].splice(a,1);return e.reindexFormObject(c)};this.updateFormObjectIndex=function(c,a,b){var d;if(a!==b)return d=e.forms[c],a=d.splice(a,1)[0],d.splice(b,0,a),e.reindexFormObject(c)};this.$get=this.get=function(){return{version:this.version,components:this.components,groups:this.groups,forms:this.forms,
broadcastChannel:this.broadcastChannel,registerComponent:this.registerComponent,addFormObject:this.addFormObject,insertFormObject:this.insertFormObject,removeFormObject:this.removeFormObject,updateFormObjectIndex:this.updateFormObjectIndex}}})}).call(this);
