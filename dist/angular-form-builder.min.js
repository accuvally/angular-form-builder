...
1]+1E3);d=-1;for(k=n=a.formObjects.length-1;0<=n;k=n+=-1)if(!a.formObjects[k].editable){d=k;break}k=d=0<=d?d+2:1;for(n=g.length;d<n;k=d+=1)if(e.pageY>g[k-1]&&e.pageY<=g[k]){$(b).find(".empty").remove();e=$("<div class='fb-form-object-editable empty'></div>");k-1<h.length?e.insertBefore($(h[k-1])):e.insertAfter($(h[k-2]));break}}},out:function(){f&&($("div.fb-form-object-editable").popover("hide"),f=!1);return $(b).find(".empty").remove()},up:function(c,d,g){f=!0;if(k.isMouseMoved())return d||"drag"!==
g.mode?d&&("mirror"===g.mode&&h.insertFormObject(a.formName,$(b).find(".empty").index(".fb-form-object-editable"),{component:g.object.componentName}),"drag"===g.mode&&(d=g.object.formObject.index,c=$(b).find(".empty").index(".fb-form-object-editable"),d<c&&c--,h.updateFormObjectIndex(a.formName,d,c))):(c=g.object.formObject,c.editable&&h.removeFormObject(e.fbBuilder,c.index)),$(b).find(".empty").remove();$(b).find(".empty").remove()}})}}};d.$inject=["$injector"];l.directive("fbBuilder",d);d=function(c){return{restrict:"A",
controller:"fbFormObjectEditableController",link:function(a,b,e){var h,k,d,g,n,m,p,q;g=c.get("$builder");m=c.get("$drag");d=c.get("$parse");n=c.get("$compile");p=c.get("$validator");d=d(e.fbFormObjectEditable)(a);e=g.components[d.component];a.setupScope(d);q=n(e.template)(a);$(b).append(q);$(b).on("click",function(){return!1});if(d.editable)return m.draggable($(b),{object:{formObject:d}}),h="fb-"+Math.random().toString().substr(2),k=!1,d=null,d=e.popoverTemplate,d=$(d).addClass(h),a.popover={save:function(e){e.preventDefault();
...
template:'<div class=\'fb-form-object\' ng-repeat="object in form" fb-form-object="object"></div>',controller:"fbFormController",link:function(a,b,e){b=c.get("$builder");return a.form=b.forms[e.fbForm]}}};d.$inject=["$injector"];l.directive("fbForm",d);d=function(c){return{restrict:"A",controller:"fbFormObjectController",link:function(a,b,e){var d,k,f;d=c.get("$builder");k=c.get("$compile");f=c.get("$parse");a.formObject=f(e.fbFormObject)(a);f=d.components[a.formObject.component];a.$on(d.broadcastChannel.updateInput,
function(){var b;return a.updateInput([null!=(b=a.inputText)?b:""])});f.arrayToText&&(a.inputArray=[],a.$watch("inputArray",function(b,e){var c,d;if(b!==e){c=[];for(d in a.inputArray)a.inputArray[d]&&c.push(a.options[d]);return a.updateInput(c)}},!0));a.$watch("inputText",function(b){return a.updateInput([b])});a.$watch(e.fbFormObject,function(){return a.copyObjectToScope(a.formObject)},!0);e=$(f.template);e.find("[ng-model='inputText']").attr({validator:"{{validation}}","validator-error":"{{errorMessage}}"});
k=k(e)(a);$(b).append(k);if(!f.arrayToText&&0<a.formObject.options.length)return a.inputText=a.formObject.options[0]}}};d.$inject=["$injector"];l.directive("fbFormObject",d)}).call(this);
...
!1;return a.autoScroll.down=!1}};this.dragMirrorMode=function(b,e,c){var d;null==e&&(e=!0);d={id:a.getNewId(),mode:"mirror",maternal:b[0],element:null,object:c};b.on("mousedown",function(c){var g;c.preventDefault();g=b.clone();d.element=g[0];g.addClass("fb-draggable form-horizontal prepare-dragging");a.hooks.move.drag=function(e,c){var h,f,l,r;if(g.hasClass("prepare-dragging")&&(g.css({width:b.width(),height:b.height()}),g.removeClass("prepare-dragging"),g.addClass("dragging"),c))return;g.offset({left:e.pageX-
g.width()/2,top:e.pageY-g.height()/2});a.autoScroll.start(e);l=a.data.droppables;r=[];for(f in l)h=l[f],a.isHover(g,$(h.element))?r.push(h.move(e,d)):r.push(h.out(e,d));return r};a.hooks.up.drag=function(b){var e,c,h,f;f=a.data.droppables;for(c in f)e=f[c],h=a.isHover(g,$(e.element)),e.up(b,h,d);delete a.hooks.move.drag;delete a.hooks.up.drag;d.element=null;g.remove();return a.autoScroll.stop()};$("body").append(g);if(!e)return a.hooks.move.drag(c,e)});return d};this.dragDragMode=function(b,e,c){var d;
null==e&&(e=!0);d={id:a.getNewId(),mode:"drag",maternal:null,element:b[0],object:c};b.addClass("fb-draggable");b.on("mousedown",function(c){c.preventDefault();if(!b.hasClass("dragging")&&(b.addClass("prepare-dragging"),a.hooks.move.drag=function(e,c){var h,f,l;if(b.hasClass("prepare-dragging")&&(b.css({width:b.width(),height:b.height()}),b.removeClass("prepare-dragging"),b.addClass("dragging"),c))return;b.offset({left:e.pageX-b.width()/2,top:e.pageY-b.height()/2});a.autoScroll.start(e);l=a.data.droppables;
for(f in l)h=l[f],a.isHover(b,$(h.element))?h.move(e,d):h.out(e,d)},a.hooks.up.drag=function(e){var c,h,f,l;l=a.data.droppables;for(h in l)c=l[h],f=a.isHover(b,$(c.element)),c.up(e,f,d);delete a.hooks.move.drag;delete a.hooks.up.drag;b.css({width:"",height:"",left:"",top:""});b.removeClass("dragging defer-dragging");return a.autoScroll.stop()},!e))return a.hooks.move.drag(c,e)});return d};this.dropMode=function(b,e){return{id:a.getNewId(),element:b[0],move:function(a,b){return d.$apply(function(){return"function"===
typeof e.move?e.move(a,b):void 0})},up:function(a,b,c){return d.$apply(function(){return"function"===typeof e.up?e.up(a,b,c):void 0})},out:function(a,b){return d.$apply(function(){return"function"===typeof e.out?e.out(a,b):void 0})}}};this.draggable=function(b,e){var c,d,f,g;null==e&&(e={});d=[];if("mirror"===e.mode)for(f=0,g=b.length;f<g;f++)c=b[f],c=a.dragMirrorMode($(c),e.defer,e.object),d.push(c.id),a.data.draggables[c.id]=c;else for(f=0,g=b.length;f<g;f++)c=b[f],c=a.dragDragMode($(c),e.defer,
e.object),d.push(c.id),a.data.draggables[c.id]=c;return d};this.droppable=function(b,c){var d,k,f,g;null==c&&(c={});k=[];f=0;for(g=b.length;f<g;f++)d=b[f],d=a.dropMode($(d),c),k.push(d),a.data.droppables[d.id]=d;return k};this.get=function(a){this.setupEasing();this.setupProviders(a);return{isMouseMoved:this.isMouseMoved,data:this.data,draggable:this.draggable,droppable:this.droppable}};this.get.$inject=["$injector"];this.$get=this.get})}).call(this);(function(){angular.module("builder",["builder.directive"])}).call(this);
(function(){var l=[].indexOf||function(d){for(var c=0,a=this.length;c<a;c++)if(c in this&&this[c]===d)return c;return-1};angular.module("builder.provider",[]).provider("$builder",function(){var d=this;this.version="0.0.0";this.components={};this.groups=[];this.broadcastChannel={updateInput:"$updateInput"};this.forms={"default":[]};this.s4=function(){return Math.floor(65536*(1+Math.random())).toString(16).substr(1)};this.getNewGuid=function(){return""+this.s4()+this.s4()+"-"+this.s4()+"-"+this.s4()+
"-"+this.s4()+"-"+this.s4()+this.s4()+this.s4()};this.getEmptyGuid=function(){return"00000000-0000-0000-0000-000000000000"};this.convertComponent=function(c,a){var b,d,h,k,f,g,l,m,p,q,s,r;b={name:c,group:null!=(d=a.group)?d:"Default",label:null!=(h=a.label)?h:"",description:null!=(f=a.description)?f:"",placeholder:null!=(g=a.placeholder)?g:"",editable:null!=(l=a.editable)?l:!0,required:null!=(m=a.required)?m:!1,validation:null!=(p=a.validation)?p:"/.*/",validationOptions:null!=(q=a.validationOptions)?
q:[],errorMessage:null!=(s=a.errorMessage)?s:"",options:null!=(r=a.options)?r:[],arrayToText:null!=(k=a.arrayToText)?k:!1,template:a.template,popoverTemplate:a.popoverTemplate};b.template||console.error("The template is empty.");b.popoverTemplate||console.error("The popoverTemplate is empty.");return b};this.convertFormObject=function(c,a){var b,d,h,k,f,g,l,m,p,q,s;null==a&&(a={});b=this.components[a.component];if(null==b)throw"The component "+a.component+" was not registered.";return{id:null!=(d=
a.id)?d:this.getNewGuid(),component:a.component,editable:null!=(h=a.editable)?h:b.editable,index:null!=(k=a.index)?k:0,label:null!=(f=a.label)?f:b.label,description:null!=(g=a.description)?g:b.description,placeholder:null!=(l=a.placeholder)?l:b.placeholder,options:null!=(m=a.options)?m:b.options,required:null!=(p=a.required)?p:b.required,validation:null!=(q=a.validation)?q:b.validation,errorMessage:null!=(s=a.errorMessage)?s:b.errorMessage}};this.reindexFormObject=function(c){var a,b,e;c=d.forms[c];
a=b=0;for(e=c.length-1;b<=e;a=b+=1)c[a].index=a};this.registerComponent=function(c,a){var b,e;null==a&&(a={});null==d.components[c]?(b=d.convertComponent(c,a),d.components[c]=b,(e=b.group,0>l.call(d.groups,e))&&d.groups.push(b.group)):console.error("The component "+c+" was registered.")};this.addFormObject=function(c,a){var b;null==a&&(a={});null==(b=d.forms)[c]&&(b[c]=[]);return d.insertFormObject(c,d.forms[c].length,a)};this.insertFormObject=function(c,a,b){var e;null==b&&(b={});null==(e=d.forms)[c]&&
(e[c]=[]);a>d.forms[c].length?a=d.forms[c].length:0>a&&(a=0);d.forms[c].splice(a,0,d.convertFormObject(c,b));return d.reindexFormObject(c)};this.removeFormObject=function(c,a){d.forms[c].splice(a,1);return d.reindexFormObject(c)};this.updateFormObjectIndex=function(c,a,b){var e;if(a!==b)return e=d.forms[c],a=e.splice(a,1)[0],e.splice(b,0,a),d.reindexFormObject(c)};this.$get=this.get=function(){return{version:this.version,components:this.components,groups:this.groups,forms:this.forms,broadcastChannel:this.broadcastChannel,
