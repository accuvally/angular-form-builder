(function(){var g,e,c;g=angular.module("builder.controller",["builder.provider"]);e=function(a,b){var d,l;for(d in a)l=a[d],"$$hashKey"!==d&&(b[d]=l)};c=function(a,b){var d;d=b.get("$builder");a.setupScope=function(b){e(b,a);a.optionsText=b.options.join("\n");a.$watch("[label, description, placeholder, required, options, validation]",function(){b.label=a.label;b.Label=a.label;b.description=a.description;b.Description=a.description;b.placeholder=a.placeholder;b.Placeholder=a.placeholder;b.required=
a.required;b.Required=a.required;b.options=a.options;b.Options=a.options;b.validation=a.validation;return b.Validation=a.validation},!0);b.IdNumber=b.id;a.$watch("optionsText",function(b){var d,l,c,h;c=b.split("\n");h=[];d=0;for(l=c.length;d<l;d++)b=c[d],0<b.length&&h.push(b);a.options=h;return a.inputText=a.options[0]});return a.validationOptions=d.components[b.component].validationOptions};return a.data={model:null,backup:function(){return this.model={label:a.label,description:a.description,placeholder:a.placeholder,
required:a.required,optionsText:a.optionsText,validation:a.validation}},rollback:function(){if(this.model)return a.label=this.model.label,a.description=this.model.description,a.placeholder=this.model.placeholder,a.required=this.model.required,a.optionsText=this.model.optionsText,a.validation=this.model.validation}}};c.$inject=["$scope","$injector"];g.controller("fbFormObjectEditableController",c);c=function(a,b){var d;d=b.get("$builder");a.selectGroup=function(b,f){var c,k,m,h;null!=b&&b.preventDefault();
a.activeGroup=f;a.components=[];m=d.components;h=[];for(k in m)c=m[k],c.group===f&&h.push(a.components.push(c));return h};a.groups=d.groups;a.activeGroup=a.groups[0];a.allComponents=d.components;return a.$watch("allComponents",function(){return a.selectGroup(null,a.activeGroup)})};c.$inject=["$scope","$injector"];g.controller("fbComponentsController",c);c=function(a){return a.copyObjectToScope=function(b){return e(b,a)}};c.$inject=["$scope"];g.controller("fbComponentController",c);c=function(a,b){var d,
...
Value:null!=b?b:[]})}};c.$inject=["$scope","$injector"];g.controller("fbFormObjectController",c)}).call(this);
...
f.removeFormObject(l.fbBuilder,h.index)),$(d).find(".empty").remove();$(d).find(".empty").remove()}})}}};e.$inject=["$injector"];g.directive("fbBuilder",e);e=function(a){return{restrict:"A",controller:"fbFormObjectEditableController",link:function(b,d,l){var f,c,k,m,h,e,q,g;m=a.get("$builder");e=a.get("$drag");k=a.get("$parse");h=a.get("$compile");q=a.get("$validator");k=k(l.fbFormObjectEditable)(b);l=m.components[k.component];b.setupScope(k);g=h(l.template)(b);$(d).append(g);$(d).on("click",function(){return!1});
if(k.editable)return e.draggable($(d),{object:{formObject:k}}),f="fb-"+Math.random().toString().substr(2),c=!1,k=null,k=l.popoverTemplate,k=$(k).addClass(f),b.popover={save:function(a){a.preventDefault();q.validate(b).success(function(){c=!0;return $(d).popover("hide")})},remove:function(a){a.preventDefault();m.removeFormObject(b.formName,b.$index);$(d).popover("hide")},shown:function(){b.data.backup();return c=!1},cancel:function(a){b.data.rollback();a&&(a.preventDefault(),$(d).popover("hide"))}},
...
for(a in c)d=c[a],b[a.replace(/^\w?/,a.substr(0,1).toLowerCase())]=d;return b}};this.convertComponent=function(c,a){var b,d,e,f,g,k,m,h,n,q,r,p;b={name:c,group:null!=(d=a.group)?d:"Default",label:null!=(e=a.label)?e:"",description:null!=(g=a.description)?g:"",placeholder:null!=(k=a.placeholder)?k:"",editable:null!=(m=a.editable)?m:!0,required:null!=(h=a.required)?h:!1,validation:null!=(n=a.validation)?n:"/.*/",validationOptions:null!=(q=a.validationOptions)?q:[],errorMessage:null!=(r=a.errorMessage)?
r:"",options:null!=(p=a.options)?p:[],arrayToText:null!=(f=a.arrayToText)?f:!1,template:a.template,popoverTemplate:a.popoverTemplate};b.template||console.error("The template is empty.");b.popoverTemplate||console.error("The popoverTemplate is empty.");return b};this.convertFormObject=function(c,a){var b,d,e,f,g,k,m,h,n,q,r,p;null==a&&(a={});a=this.bleach.toLowerCase(a);a.id=null!=(b=a.id)?b:a.idNumber;a.index=null!=(d=a.index)?d:a.orderBy;b=this.components[a.component];if(null==b)throw"The component "+
a.component+" was not registered.";return{id:null!=(g=a.id)?g:null,component:a.component,editable:null!=(k=a.editable)?k:b.editable,index:null!=(m=a.index)?m:0,label:null!=(h=a.label)?h:b.label,description:null!=(n=a.description)?n:b.description,placeholder:null!=(q=a.placeholder)?q:b.placeholder,options:null!=(r=a.options)?r:b.options,required:null!=(p=a.required)?p:b.required,validation:null!=(e=a.validation)?e:b.validation,errorMessage:null!=(f=a.errorMessage)?f:b.errorMessage}};this.reindexFormObject=
function(c){var a,b,d;c=e.forms[c];a=b=0;for(d=c.length;b<d;a=b+=1)c[a].index=a,c[a].OrderBy=a};this.registerComponent=function(c,a){var b,d;null==a&&(a={});null==e.components[c]?(b=e.convertComponent(c,a),e.components[c]=b,(d=b.group,0>g.call(e.groups,d))&&e.groups.push(b.group)):console.error("The component "+c+" was registered.")};this.addFormObject=function(c,a){var b;null==a&&(a={});null==(b=e.forms)[c]&&(b[c]=[]);return e.insertFormObject(c,e.forms[c].length,a)};this.insertFormObject=function(c,
a,b){var d;null==b&&(b={});null==(d=e.forms)[c]&&(d[c]=[]);a>e.forms[c].length?a=e.forms[c].length:0>a&&(a=0);e.forms[c].splice(a,0,e.convertFormObject(c,b));return e.reindexFormObject(c)};this.removeFormObject=function(c,a){e.forms[c].splice(a,1);return e.reindexFormObject(c)};this.updateFormObjectIndex=function(c,a,b){var d;if(a!==b)return d=e.forms[c],a=d.splice(a,1)[0],d.splice(b,0,a),e.reindexFormObject(c)};this.$get=this.get=function(){return{version:this.version,components:this.components,
