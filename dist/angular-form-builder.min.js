...
template:'<div class=\'fb-form-object\' ng-repeat="object in form" fb-form-object="object"></div>',controller:"fbFormController",link:function(a,b,d){b=c.get("$builder");a.formName=d.fbForm;return a.form=b.forms[a.formName]}}};e.$inject=["$injector"];h.directive("fbForm",e);e=function(c){return{restrict:"A",controller:"fbFormObjectController",link:function(a,b,d){var f,m,e;f=c.get("$builder");m=c.get("$compile");e=c.get("$parse");a.formObject=e(d.fbFormObject)(a);e=f.components[a.formObject.component];
a.$on(f.broadcastChannel.updateInput,function(){var b;return a.updateInput([null!=(b=a.inputText)?b:""])});e.arrayToText&&(a.inputArray=[],a.$watch("inputArray",function(b,d){var c,f;if(b!==d){c=[];for(f in a.inputArray)a.inputArray[f]&&c.push(a.options[f]);return a.updateInput(c)}},!0));a.$watch("inputText",function(b){return a.updateInput([b])});a.$watch(d.fbFormObject,function(){return a.copyObjectToScope(a.formObject)},!0);d=$(e.template);d.find("[ng-model='inputText']").attr({validator:"{{validation}}",
"validator-error":"{{errorMessage}}"});m=m(d)(a);$(b).append(m);if(!e.arrayToText&&0<a.formObject.options.length)return a.inputText=a.formObject.options[0]}}};e.$inject=["$injector"];h.directive("fbFormObject",e)}).call(this);
